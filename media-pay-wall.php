...
/**
 * Media Pay Wall Pro plugin to add audio/video restriction functionality, remove monthly payment and make compatibiltiy with Media Pay Wall with Erphpdown
 *
 * @package Funny Dev.
 * @since 1.0.0
 */
...
/*
Plugin Name: Media Pay Wall Pro
Plugin URI: https://zeen101.com/
Description: Media Paywall Wall pro plugin to add image/audio/video restriction, remove monthly payment and make compatibiltiy with Media Pay Wall
Author: Funny Dev.
Version: 1.0
Author URI:
